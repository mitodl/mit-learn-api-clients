...
export const VectorLearningResourcesSearchApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async vectorLearningResourcesSearchRetrieve(aggregations?: Array<VectorLearningResourcesSearchRetrieveAggregationsEnum>, certification?: boolean | null, certification_type?: Array<VectorLearningResourcesSearchRetrieveCertificationTypeEnum>, completeness_penalty?: number | null, course_feature?: Array<string>, delivery?: Array<VectorLearningResourcesSearchRetrieveDeliveryEnum>, department?: Array<VectorLearningResourcesSearchRetrieveDepartmentEnum>, free?: boolean | null, hybrid_search?: boolean, level?: Array<VectorLearningResourcesSearchRetrieveLevelEnum>, limit?: number, ocw_topic?: Array<string>, offered_by?: Array<VectorLearningResourcesSearchRetrieveOfferedByEnum>, offset?: number, platform?: Array<VectorLearningResourcesSearchRetrievePlatformEnum>, professional?: boolean | null, program_boost?: number | null, published?: boolean, q?: string, readable_id?: string, resource_category?: Array<string>, resource_type?: Array<VectorLearningResourcesSearchRetrieveResourceTypeEnum>, resource_type_group?: Array<VectorLearningResourcesSearchRetrieveResourceTypeGroupEnum>, score_cutoff?: number, sortby?: VectorLearningResourcesSearchRetrieveSortbyEnum, staleness_horizon_years?: number | null, staleness_penalty?: number | null, title__isnull?: boolean | null, topic?: Array<string>, url__isnull?: boolean | null, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<LearningResourcesVectorSearchResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.vectorLearningResourcesSearchRetrieve(aggregations, certification, certification_type, completeness_penalty, course_feature, delivery, department, free, hybrid_search, level, limit, ocw_topic, offered_by, offset, platform, professional, program_boost, published, q, readable_id, resource_category, resource_type, resource_type_group, score_cutoff, sortby, staleness_horizon_years, staleness_penalty, title__isnull, topic, url__isnull, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export class VectorLearningResourcesSearchApi extends BaseAPI {
    ...
    public vectorLearningResourcesSearchRetrieve(requestParameters: VectorLearningResourcesSearchApiVectorLearningResourcesSearchRetrieveRequest = {}, options?: RawAxiosRequestConfig) {
        return VectorLearningResourcesSearchApiFp(this.configuration).vectorLearningResourcesSearchRetrieve(requestParameters.aggregations, requestParameters.certification, requestParameters.certification_type, requestParameters.completeness_penalty, requestParameters.course_feature, requestParameters.delivery, requestParameters.department, requestParameters.free, requestParameters.hybrid_search, requestParameters.level, requestParameters.limit, requestParameters.ocw_topic, requestParameters.offered_by, requestParameters.offset, requestParameters.platform, requestParameters.professional, requestParameters.program_boost, requestParameters.published, requestParameters.q, requestParameters.readable_id, requestParameters.resource_category, requestParameters.resource_type, requestParameters.resource_type_group, requestParameters.score_cutoff, requestParameters.sortby, requestParameters.staleness_horizon_years, requestParameters.staleness_penalty, requestParameters.title__isnull, requestParameters.topic, requestParameters.url__isnull, options).then((request) => request(this.axios, this.basePath));
    }
}
