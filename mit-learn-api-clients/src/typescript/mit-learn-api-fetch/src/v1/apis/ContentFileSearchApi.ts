...
export class ContentFileSearchApi extends runtime.BaseAPI {
     ...
     * Search
     */
    async contentFileSearchRetrieveRaw(requestParameters: ContentFileSearchRetrieveRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ContentFileSearchResponse>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ContentFileSearchResponseFromJSON(jsonValue));
    }
     ...
     * Search
     */
    async contentFileSearchRetrieve(requestParameters: ContentFileSearchRetrieveRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ContentFileSearchResponse> {
        const response = await this.contentFileSearchRetrieveRaw(requestParameters, initOverrides);
