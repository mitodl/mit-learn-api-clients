...
export class PodcastEpisodesApi extends runtime.BaseAPI {
     ...
     * List
     */
    async podcastEpisodesListRaw(requestParameters: PodcastEpisodesListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PaginatedPodcastEpisodeResourceList>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => PaginatedPodcastEpisodeResourceListFromJSON(jsonValue));
    }
     ...
     * List
     */
    async podcastEpisodesList(requestParameters: PodcastEpisodesListRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PaginatedPodcastEpisodeResourceList> {
        const response = await this.podcastEpisodesListRaw(requestParameters, initOverrides);
     ...
     * Retrieve
     */
    async podcastEpisodesRetrieveRaw(requestParameters: PodcastEpisodesRetrieveRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PodcastEpisodeResource>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling podcastEpisodesRetrieve.');
        }
        ...
        const response = await this.request({
            path: `/api/v1/podcast_episodes/{id}/`.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters.id))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => PodcastEpisodeResourceFromJSON(jsonValue));
    }
     ...
     * Retrieve
     */
    async podcastEpisodesRetrieve(requestParameters: PodcastEpisodesRetrieveRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PodcastEpisodeResource> {
        const response = await this.podcastEpisodesRetrieveRaw(requestParameters, initOverrides);
        return await response.value();
    }
