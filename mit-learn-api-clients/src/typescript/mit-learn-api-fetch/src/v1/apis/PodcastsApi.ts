...
export class PodcastsApi extends runtime.BaseAPI {
  ...
  async podcastsItemsListRaw(
    ...
    if (
      ...
      throw new runtime.RequiredError(
        ...
        "Required parameter requestParameters.learning_resource_id was null or undefined when calling podcastsItemsList.",
      )
    }
    ...
    const response = await this.request(
      {
        path: `/api/v1/podcasts/{learning_resource_id}/items/`.replace(
          `{${"learning_resource_id"}}`,
  ...
  async podcastsItemsRetrieveRaw(
    ...
    if (requestParameters.id === null || requestParameters.id === undefined) {
      throw new runtime.RequiredError(
        "id",
        "Required parameter requestParameters.id was null or undefined when calling podcastsItemsRetrieve.",
      )
    }
    ...
    if (
      ...
      throw new runtime.RequiredError(
        "learning_resource_id",
        "Required parameter requestParameters.learning_resource_id was null or undefined when calling podcastsItemsRetrieve.",
      )
    }
    ...
    const response = await this.request(
      {
        path: `/api/v1/podcasts/{learning_resource_id}/items/{id}/`
          .replace(
            `{${"id"}}`,
  ...
  async podcastsRetrieveRaw(
    ...
    if (requestParameters.id === null || requestParameters.id === undefined) {
      throw new runtime.RequiredError(
        "id",
        "Required parameter requestParameters.id was null or undefined when calling podcastsRetrieve.",
      )
    }
    ...
    const response = await this.request(
      {
        path: `/api/v1/podcasts/{id}/`.replace(
          `{${"id"}}`,
          encodeURIComponent(String(requestParameters.id)),
        ),
        method: "GET",
