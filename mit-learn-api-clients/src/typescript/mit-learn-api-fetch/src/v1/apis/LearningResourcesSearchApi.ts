...
export class LearningResourcesSearchApi extends runtime.BaseAPI {
     ...
     * Search
     */
    async learningResourcesSearchRetrieveRaw(requestParameters: LearningResourcesSearchRetrieveRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<LearningResourcesSearchResponse>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => LearningResourcesSearchResponseFromJSON(jsonValue));
    }
     ...
     * Search
     */
    async learningResourcesSearchRetrieve(requestParameters: LearningResourcesSearchRetrieveRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<LearningResourcesSearchResponse> {
        const response = await this.learningResourcesSearchRetrieveRaw(requestParameters, initOverrides);
...
export type LearningResourcesSearchRetrieveSearchModeEnum = typeof LearningResourcesSearchRetrieveSearchModeEnum[keyof typeof LearningResourcesSearchRetrieveSearchModeEnum];
/**
 * @export
 */
