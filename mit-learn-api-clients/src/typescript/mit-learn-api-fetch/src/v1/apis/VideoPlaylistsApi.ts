...
export class VideoPlaylistsApi extends runtime.BaseAPI {
  ...
  async videoPlaylistsItemsListRaw(
    ...
    if (
      ...
      throw new runtime.RequiredError(
        ...
        "Required parameter requestParameters.learning_resource_id was null or undefined when calling videoPlaylistsItemsList.",
      )
    }
    ...
    const response = await this.request(
      {
        path: `/api/v1/video_playlists/{learning_resource_id}/items/`.replace(
          `{${"learning_resource_id"}}`,
  ...
  async videoPlaylistsItemsRetrieveRaw(
    ...
    if (requestParameters.id === null || requestParameters.id === undefined) {
      throw new runtime.RequiredError(
        "id",
        "Required parameter requestParameters.id was null or undefined when calling videoPlaylistsItemsRetrieve.",
      )
    }
    ...
    if (
      ...
      throw new runtime.RequiredError(
        "learning_resource_id",
        "Required parameter requestParameters.learning_resource_id was null or undefined when calling videoPlaylistsItemsRetrieve.",
      )
    }
    ...
    const response = await this.request(
      {
        path: `/api/v1/video_playlists/{learning_resource_id}/items/{id}/`
          .replace(
            `{${"id"}}`,
  ...
  async videoPlaylistsRetrieveRaw(
    ...
    if (requestParameters.id === null || requestParameters.id === undefined) {
      throw new runtime.RequiredError(
        "id",
        "Required parameter requestParameters.id was null or undefined when calling videoPlaylistsRetrieve.",
      )
    }
    ...
    const response = await this.request(
      {
        path: `/api/v1/video_playlists/{id}/`.replace(
          `{${"id"}}`,
          encodeURIComponent(String(requestParameters.id)),
        ),
        method: "GET",
