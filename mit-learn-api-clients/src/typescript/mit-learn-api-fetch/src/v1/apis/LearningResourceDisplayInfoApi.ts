...
export class LearningResourceDisplayInfoApi extends runtime.BaseAPI {
     ...
     * List
     */
    async learningResourceDisplayInfoListRaw(requestParameters: LearningResourceDisplayInfoListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PaginatedLearningResourceDisplayInfoResponseList>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => PaginatedLearningResourceDisplayInfoResponseListFromJSON(jsonValue));
    }
     ...
     * List
     */
    async learningResourceDisplayInfoList(requestParameters: LearningResourceDisplayInfoListRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PaginatedLearningResourceDisplayInfoResponseList> {
        const response = await this.learningResourceDisplayInfoListRaw(requestParameters, initOverrides);
     ...
     * Retrieve
     */
    async learningResourceDisplayInfoRetrieveRaw(requestParameters: LearningResourceDisplayInfoRetrieveRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<LearningResourceDisplayInfoResponse>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling learningResourceDisplayInfoRetrieve.');
        }
        ...
        const response = await this.request({
            path: `/api/v1/learning_resource_display_info/{id}/`.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters.id))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => LearningResourceDisplayInfoResponseFromJSON(jsonValue));
    }
     ...
     * Retrieve
     */
    async learningResourceDisplayInfoRetrieve(requestParameters: LearningResourceDisplayInfoRetrieveRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<LearningResourceDisplayInfoResponse> {
        const response = await this.learningResourceDisplayInfoRetrieveRaw(requestParameters, initOverrides);
        return await response.value();
    }
