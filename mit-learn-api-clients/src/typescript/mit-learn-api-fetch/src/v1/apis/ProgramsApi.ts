...
export class ProgramsApi extends runtime.BaseAPI {
     ...
     * List
     */
    async programsListRaw(requestParameters: ProgramsListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PaginatedProgramResourceList>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => PaginatedProgramResourceListFromJSON(jsonValue));
    }
     ...
     * List
     */
    async programsList(requestParameters: ProgramsListRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PaginatedProgramResourceList> {
     ...
     * Retrieve
     */
    async programsRetrieveRaw(requestParameters: ProgramsRetrieveRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ProgramResource>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling programsRetrieve.');
        }
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ProgramResourceFromJSON(jsonValue));
    }
     ...
     * Retrieve
     */
    async programsRetrieve(requestParameters: ProgramsRetrieveRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ProgramResource> {
        const response = await this.programsRetrieveRaw(requestParameters, initOverrides);
        return await response.value();
    }
