...
export function CurrentEducationEnumFromJSONTyped(json: any, ignoreDiscriminator: boolean): CurrentEducationEnum {
    return json as CurrentEducationEnum;
}

export function CurrentEducationEnumToJSON(value?: CurrentEducationEnum | null): any {
    return value as any;
}
